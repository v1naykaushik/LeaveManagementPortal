...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fluid">
        ...
        <div class="save-button-container">
            ...
            <asp:Button ID="btnSaveChanges" runat="server" Text="Save Changes" 
                      CssClass="btn-save" OnClick="btnSaveChanges_Click" Enabled="false" />
        </div>
    ...
    <script type="text/javascript">
        ...
        function markForAction(leaveId, action) {
            pendingActions[leaveId] = action;
            
            // Find and check the checkbox for this leave
            const checkbox = document.querySelector(`.tile-checkbox[data-leaveid="${leaveId}"]`);
            if (checkbox) {
                checkbox.checked = true;
                selectedLeaves.add(leaveId.toString());
            }
        ...
        function showLeaveDetails(employeeName, leaveType, startDate, endDate, duration, employeeId, reason, isHalfDay, managerStatus, directorStatus) {
            ...
            try {
                ...
                document.getElementById('modalDuration').textContent = isHalfDay ? 'Half Day' : duration + (duration === '1' ? ' day' : ' days');
        ...
        // Add hidden field for storing data before form submission
        function setHiddenField() {
            var hiddenField = document.getElementById('<%= hdnPendingActions.ClientID %>');
            hiddenField.value = prepareSubmissionData();
        }
    </script>
